...
No topo da aba Calcular, cada veículo (carro e moto) tem o próprio bloco **KM**:

1. Digite o **KM atual** (ex.: 124.535) e, se quiser, a **próxima troca** (ex.: 129.535). Os botões +5.000 e +10.000 km preenchem a troca a partir do KM atual.
2. Toque em **Salvar KM**. Enquanto o KM não for salvo, a calculadora fica travada.
3. Depois de salvo, o bloco mostra o KM, a próxima troca e quanto falta ("Faltam 1 km para a troca"). Toque em **Alterar KM** sempre que quiser atualizar.
4. Ao registrar um abastecimento, o app usa o KM salvo. Atualize o KM antes de abastecer para o consumo real (km/l) ficar correto.
5. Se faltarem 500 km ou menos para a troca, ou se ela vencer, o sino avisa.
